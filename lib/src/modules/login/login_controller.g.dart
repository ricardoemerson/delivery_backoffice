...
mixin _$LoginController on LoginControllerBase, Store {
  late final _$_loginStateAtom =
      Atom(name: 'LoginControllerBase._loginState', context: context);

  LoginStateEnum get loginState {
    _$_loginStateAtom.reportRead();
    return super._loginState;
  }

  @override
  LoginStateEnum get _loginState => loginState;

  @override
  set _loginState(LoginStateEnum value) {
